...
//         <div className="mb-6">
//           <h1 className="text-3xl font-bold text-white mb-2">JSON Editor</h1>
...
//                 <button
//                   onClick={minifyJson}
//                   className="flex items-center gap-1 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm transition-colors"
//                   title="Minify JSON"
//                 >
//                   <Minimize2 size={16} />
//                   Minify
...
//           {/* Tree View Panel */}
//           <div className="bg-gray-800 rounded-lg shadow-xl p-6">
//             <h2 className="text-xl font-semibold text-white mb-4">Tree View</h2>
