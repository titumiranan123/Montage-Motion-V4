    ...
    <div className="space-y-2">
      {items?.map((item, index) => (
        <div
          ...
          key={index}
          className="text-white lg:max-w-[996px] mx-auto bg-[#080B0C] backdrop-blur-[21px] rounded-[18px] overflow-hidden min-h-[68px]"
        >
          <div
          ...
          >
            ...
            <div className="flex-shrink-0 ml-4 border rounded-full">
              <svg
