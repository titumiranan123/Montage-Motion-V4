      ...
      <div className="text-white flex flex-col items-start justify-center w-full">
        <div>
          <h2
            data-aos="fade-up"
            data-aos-delay={100}
            className="md:text-[56px] text-[32px] leading-[120%] font-[600] poppins"
          >
            Have a Project ?
          </h2>
          <h2
          ...
          <p
            data-aos="fade-up"
            data-aos-delay={300}
            className="text-[14px] mt-2 md:text-[16px] opensans font-[400]  leading-[140%]"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay={500}
            className="text-[14px] md:text-[16px] opensans font-[400] leading-[140%]"
          >
