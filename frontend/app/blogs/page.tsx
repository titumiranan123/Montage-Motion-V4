    ...
    <div className="relative container lg:mt-20 mt-16 min-h-screen header-background pagelogo">
      <div className="text-white flex flex-col justify-center items-center lg:w-[695px] gap-6 mx-auto w-full">
        <h2
          data-aos="fade-up"
          data-aos-delay="300"
          className="satoshi gradienttext"
        >
          Read Our Blogs
        </h2>
...
const Blogcard = ({
  ...
  return (
    <Link
      ...
      href={`/blogs/${slug}`}
      className="lg:w-[488px] block cursor-pointer lg:h-[386.46px] rounded-[17.45px] p-4 text-[#58585833] border border-[#58585833] backdrop-blur-[25.82px] overflow-hidden"
    >
      <div className="lg:w-[456px] lg:h-[242px] overflow-hidden">
        <Image src={image} alt={title} width={456} height={242} priority />
      </div>
      <div className="mt-4">
        <h3 className="text-white md:text-[18px] text-[22px] font-[700] leading-[26px] ">
