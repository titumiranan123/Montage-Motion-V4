...
const PodcastPlanwithpurpose = () => {
  return (
    <div className="flex justify-between  container sectionGap">
      ...
      <div className="">
        ...
        <div className="max-w-[440px] max-h-[450px] w-full h-full borderbg rounded-[24px] -translate-x-32 -translate-y-80 p-[1px]">
