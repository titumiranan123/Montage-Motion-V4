      ...
      <div className="relative w-[24px] lg:flex hidden  lg:mx-4  items-center justify-center select-none">
        ...
        >
          ...
          <div
            ...
            className="pointer-events-none absolute left-1/2 -translate-x-1/2 w-[10px] h-full rounded-[25px] "
          />
          ...
          {slides.map((_, i) => (
            <div
              key={i}
              className={`absolute left-1/2 -translate-x-1/2 w-[14px] h-[14px] rounded-full transition-colors ${
          ...
          <div
            ref={fillRef}
            className="absolute top-0 left-1/2 -translate-x-1/2 w-[2px] rounded-b-full bg-[gradient-to-b "
            style={{ height: `${pctFromIndex(activeIndex)}%` }}
          />
