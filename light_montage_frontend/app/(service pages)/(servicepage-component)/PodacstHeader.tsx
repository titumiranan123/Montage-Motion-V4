    ...
    <div className="container lg:mt-24 mt-10">
      <div className="flex justify-center items-center flex-col  max-w-[928px] w-full mx-auto lg:mb-20">
        ...
        <h1
          data-aos="fade-up"
          data-aos-delay={300}
          className="poppins lg:leading-[81px] font-medium lg:text-[64px] text-[48px] leading-14  text-center text-white mt-4 mb-6"
        >
          {data?.page_title}
        </h1>
        <p
          data-aos="fade-up"
          data-aos-delay={300}
          className="text-[#c0c9ea] font-normal text-[16px] text-center max-w-[508px] mx-auto opensans"
        >
          {data?.designation}
        </p>
        ...
        <div className="w-full flex md:flex-row flex-col justify-center items-center gap-3 mt-10">
          ...
          <button
            ...
            data-aos-delay={600}
            style={{}}
            className="md:w-[155px] w-full h-12 btn-secondary text-white py-4 px-5 rounded-2xl flex justify-center items-center poppins font-medium"
          >
            Book a Call
          </button>
        </div>
