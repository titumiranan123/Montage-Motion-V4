    ...
    return (
        ...
        >
          <div className="max-w-200 mx-auto">
            ...
            {/* Paragraph Skeleton */}
            <div className="space-y-2 mt-5.75">
          ...
          <div className="mx-auto mt-25 rounded-xl overflow-hidden lg:w-249 lg:h-140.25 md:h-100 h-52.5 w-full bg-gray-300 animate-pulse">
