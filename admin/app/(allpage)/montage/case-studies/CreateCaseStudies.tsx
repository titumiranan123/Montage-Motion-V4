...
export default function CreateCaseStudyPage() {
  ...
  if (done)
    return (
      <div className="min-h-screen bg-linear-to-br from-[#0a0e14] via-[#0f141c] to-[#0a0e14] flex items-center justify-center">
        <div className={`${card} text-center max-w-md w-full`}>
          ...
          <p className="text-[#7a8899] text-sm mb-8">
            Your case study is live.
          </p>
          <button className="bg-linear-to-r from-[#1fb5dd] to-[#0d8eb0] text-white px-8 py-2.5 rounded-xl text-[14px] font-semibold">
            Create Another
          </button>
        </div>
      </div>
          ...
          <div className={show(1)}>
            <div className={card}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  <label className={lbl}>
                    Normal <span className="text-[#1fb5dd]">*</span>
                  </label>
                  <input
              ...
              <div className="mb-4">
                ...
                />
                <div className="text-right text-[11px] text-[#7a8899] mt-1">
            ...
            <div className={card}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <ImageUploader
                    title="Logo URL"
                    onChange={(url: string) => setValue("client_logo", url)}
              ...
              <div className="mb-8">
                ...
                {testimonials.fields.map((f, i) => (
                  ...
                  >
                    ...
                    <textarea
                      rows={2}
                      className={`${inpSm} w-full resize-vertical`}
